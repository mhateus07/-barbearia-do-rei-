                      ...
                      <tr key={client.id} className="hover:bg-zinc-50/50 transition-colors">
                        ...
                        <td className="px-5 py-3.5">
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <button
                              onClick={() => {
                                if (confirm(`Excluir ${client.name}?`)) deleteMutation.mutate(client.id)
                              }}
                ...
                <div key={client.id} className="rounded-2xl border border-zinc-200 bg-white p-4 space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        onClick={() => setHistoryClient(client)}
                        className="rounded-lg p-2 text-zinc-400 hover:bg-amber-50 hover:text-amber-600 transition-colors"
                        title="Histórico"
                        aria-label={`Ver histórico de ${client.name}`}
                      >
